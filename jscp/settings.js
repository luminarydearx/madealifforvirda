...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|VIRDA|❤',
...
function resetWebsiteState() {
    ...
    // Sembunyikan pesan samping (kiri & kanan) saat reset
    if (typeof hideSideMessages === 'function') {
        hideSideMessages();
    } else {
        const sideLeft = document.getElementById('sideMessageLeft');
        const sideRight = document.getElementById('sideMessageRight');
        if (sideLeft) sideLeft.classList.remove('show');
