const translations = {
    vi: {
        ...
        endOfBook: "Hết sách",
        bookHint: "Lật trang sách<br>để mở ra",
        bookHintSub: "nhấp / vuốt sang phải",
        bookHintMobile: "Vuốt sách<br>để mở ra",
    ...
    en: {
        ...
        bookHint: "Flip the book page<br>to open it",
        bookHintSub: "click / swipe right",
        bookHintMobile: "Swipe the book<br>to open it",
        loading: "Loading...",
